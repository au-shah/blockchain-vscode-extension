...
export class UserInputUtil {
    ...
    static readonly ADD_ENVIRONMENT_FROM_NODES: string = 'Add nodes from json definition files';
    static readonly ADD_ENVIRONMENT_FROM_OPS_TOOLS: string = 'Add nodes by connecting to an ops tools instance';
    static readonly KEYTAR_SERVICE_NAME: string = 'blockchain-vscode-ext';
